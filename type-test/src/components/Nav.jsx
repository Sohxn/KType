      ...
      <div className='mt-6 rounded-lg w-[70vw] flex container'>
        ...
        <div className='flex  space-x-6 ml-auto mr-6'>
          ...
          <div id='profile' className='w-12 h-12 self-center relative' >
            ...
            <div className={`prfdd absolute mt-[3vh] bg-opacity-20 border-2 rounded-xl w-fit h-fit max-w-[10vw] m-2 p-[2vh] backdrop-blur-sm ${ddOpen ? '' : 'opacity-0 translate-x-[50vh] hidden'}transition-transform duration-500 ease-in-out transform'}`}>
